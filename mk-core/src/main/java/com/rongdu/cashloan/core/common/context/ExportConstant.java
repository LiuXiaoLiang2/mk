...
public final class ExportConstant {
	...
	/** 还款记录导出 表头*/
	public static final String[] EXPORT_REPAYLOG_LIST_HEARDERS = {"真实姓名","手机号码","渠道名称","订单号", "借款金额(元)","综合费用(元)","应还金额(元)","逾期天数","应还逾期罚金(元)","应还总额(元)","实还金额(元)", "实还逾期罚金(元)",  "实还总金额(元)'", 
	...
	/** 支付记录导出 表头*/
	public static final String[] EXPORT_PAYLOG_LIST_HEARDERS = {"收款人姓名","手机号码","订单号","支付订单号","金额","收款银行卡","借款时间","打款时间","业务","状态"};
	/** 支付记录导出 属性数组*/
	public static final String[] EXPORT_PAYLOG_LIST_FIELDS = {"realName","loginName","borrowOrderNo","orderNo","amount","cardNo","loanTime","updateTime","scenesStr","stateStr"};
	...
	/** 已逾期订单导出 表头*/
	public static final String[] EXPORT_OVERDUE_LIST_HEARDERS = {"真实姓名","手机号","渠道名称","订单号","借款金额(元)","借款期限(天)","订单生成时间","综合费用(元)","居间服务费(元)","信息认证费(元)","利息(元)",
	...
	/** 催收订单导出 表头*/
	public static final String[] EXPORT_REPAYORDER_LIST_HEARDERS = {"真实姓名","手机号码","金额","还款金额","实际还款时间","借款时间","预计还款时间","逾期天数","逾期等级","罚息","催收人","订单状态"};
	/** 催收订单导出 属性*/
	public static final String[] EXPORT_REPAYORDER_LIST_FIELDS = {"borrowName","phone","amount","repayAmount","realRepayTime","borrowTime","repayTime","penaltyDay","level",
