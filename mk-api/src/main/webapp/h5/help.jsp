				...
				<div id="question_wraper">
					<div class="content">
						...
						<div class="_hidden padding info em__9">
							<p>现金贷是一款简单便捷的无抵押纯信用借款产品，借款用户只需进行线上简单认证即可申请借款，认证一般3分钟即可完成。申请通过后，最快10分钟到账，操作简单，服务费用低。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>用户注册后现金贷初始额度默认为1000元，需要通过所有认证才能激活现金贷并申请借款。具体可借额度由您提供的信息，在审核之后确定。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>贷款手续费会在还款的时候扣除。比如一笔1000元的借款，手续费为70元，实际到账为1000元，还款时为1070元。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>年龄：18-40周岁；拥有稳定的收入来源；无不良的信用记录。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>用本人实名认证的手机号注册现金贷-&gt;完成必要7步认证-&gt;申请借款额度与期限-&gt;等待审核-&gt;等待打款-&gt;收到打款。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>用户注册现金贷之后，会默认获得1000元的借款额度。用户需要做一些认证才能激活额度，具体认证事项如下：个人信息认证、工作信息认证、紧急联系人、手机运营商认证、收款银行卡绑定、授权芝麻信用、补充更多信息。做完这些信息认证之后即可申请借款。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>由于您没有授权现金贷读取联系人的权限。①ios用户，可以通过设置-&gt;隐私-&gt;通讯录-&gt;现金贷开启权限；②安卓用户，具体设置方式根据机型不同而不同。可以到设置里面开启读取权限。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>现金贷产品目前要求用户必须有芝麻信用且授权现金贷读取您的芝麻信用分数。否则无法完成借款。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>工商银行、农业银行、光大银行、邮政储蓄银行、兴业银行、建设银行、招商银行、中国银行、平安银行、华夏银行、中信银行、交通银行、民生银行、广发银行。后续还会支持更多银行。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
						...
						<div class="_hidden padding info em__9">
							<p>①【平台代扣】，在还款日之前将所需还款金额放在绑定银行卡，还款日平台将会在四个时间段进行扣款（每天10:00，13:00，16:00，20:00），扣款成功后会给您发送短信。  ②
								【支付宝还款】，用户可打开现金贷，进入还款点击支付宝转账，将还款金额转至支付宝账户中并备注好您的手机和手机号码；
								③【推荐-银行卡转账还款】，用户可打开现金贷，进入还款点击银行卡转账，将还款金额转至银行账户中并备注好您的手机和手机号码；
							</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
						...
						<div class="_hidden padding info em__9">
							<p>平台会对逾期的一笔还款收取滞纳金。若借款1000元，则收取滞纳金20元/天。</p>
						</div>
						<h3 class="em_1 _cursor">
							<span class="_inline_block _wraper"><img
								class="_hidden v_center"
