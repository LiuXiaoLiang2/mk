...
<section class="page">
  <div class="bg-fff pad-075">
    <div class="fs-08 fc-333">5.托管费、利率、币转账手续费是多少？如何计费？</div>
    <div class="fs-07 fc-666">
      <p class="mar-top-05">5.1 托管费按天计算，0.1%/天，不足一天按一天计费；</p>
      <p class="mar-top-05">5.2 计息方式是按天计算，0.1%/天，不足一天按一天计费；</p>
	  <p class="mar-top-05">5.3 币转账手续费，根据火币市场行情约0.01ETH；</p>
    </div>
  </div>
</section>
</body>
