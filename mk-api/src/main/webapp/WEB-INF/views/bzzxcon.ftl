...
<header class="header">
  <div class="weui-flex">
    ...
    <!--    <div class="weui-flex__item header-title">帮助详情</div>
    <div class="weui-flex__item header-right"></div>--> 
  </div>
</header>
<section class="page">
  <div class="bg-fff pad-075">
    <div class="fs-08 fc-333">币合约是什么？</div>
    <div class="fs-07 fc-666">
      <p class="mar-top-05">币合约是一家以数字资产作为质押物的借贷平台，为持有数字资产的用户提供安全、便捷的质押借贷服务，享受到数字资产带来福利。</p>
      <p class="mar-top-05">借款人将自己的数字资产（目前全部是数字货币）质押到“币合约”，用来借出一定价值比例的法定货币（目前只支持人民币）并遵守借款期限与利息。而“币合约”则接受借款人持有数字资产的质押担保并出借相应的法定货币资金给借款人。</p>
    </div>
  </div>
</section>
</body>
