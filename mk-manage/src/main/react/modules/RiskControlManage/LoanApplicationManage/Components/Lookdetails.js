...
import Tab9 from '../../../UserInformation/UserBasicInformation/Components/Tab9';
    ...
    return (
      <Modal title={props.title} visible={props.visible} onCancel={this.handleCancel} width="1200" footer={props.title == "查看" ? [modalBtnstwo] : [modalBtns]} maskClosable={false} >
        ...
        <Tabs defaultActiveKey="1"  >
          ...
          <TabPane tab="融360运营商报告" key="9">
            <Tab9 record={props.record} ref="Tab9" canEdit={props.canEdit} visible={props.visible} />
          </TabPane>
