    ...
    handleOk() {
        ...
        this.props.form.validateFields((errors, values) => {
            ...
            if (values.state1 == 30) {
                ...
                var params = {
					answerState:values.answerState,
                    createTime: youWant,
            ...
            <Modal title={props.title} visible={props.visible} onCancel={this.handleCancel} width="900" footer={modalBtns} maskClosable={false} >
                <div style={{ position: "relative" }}>
                    <Form horizontal form={this.props.form} style={{ marginTop: "20px" }}>
						...
						<Row>
                            <Col span="24">
                                <FormItem labelCol={{ span: 4 }} wrapperCol={{ span: 16 }} label="接收状态:">													 
								<RadioGroup  {...getFieldProps('answerState',{ rules: [{ required: true, message: '必填'}] })}  >
								    <Radio value={0}>预约还款</Radio>
									<Radio value={1}>关机</Radio>
									<Radio value={2}>停机</Radio>
									<Radio value={3}>无法接听</Radio>
									<Radio value={4}>无人接听</Radio>
									<Radio value={5}>客户设置</Radio>
									<Radio value={6}>通话中</Radio>
									<Radio value={7}>已还款</Radio>
									<Radio value={8}>其它</Radio>				
								  </RadioGroup>
							   </FormItem>
                            </Col>
                        </Row>
