package com.rongdu.cashloan.manage.push.api.example;
...
/*    protected static final String APP_KEY ="37ae7b7999d336009e363ffc";
    protected static final String MASTER_SECRET = "bbd9f283597098ec74f5f76a";*/
    protected static final String GROUP_PUSH_KEY = "2c88a01e073a0fe4fc7b167c";
    protected static final String GROUP_MASTER_SECRET = "b11314807507e2bcfdeebe2e";
	
	public static final String TITLE = "Test from API example";
    public static final String ALERT = "您好：您的借款今天到期，及时还款，避免影响信用";
 ...
 //       testSendPushWithCustomConfig();  -- 不要用
		testSendPushWithCustomConfig2(); 
//		testSendPushWithCustomConfig3(); 
//        testSendIosAlert();
//		testSendPush();
 //       testGetCidList();
 //       testSendPushes();
...
//        ApacheHttpClient httpClient = new ApacheHttpClient(authCode, null, clientConfig);
    ...
    public static PushPayload buildPushObject_all_alias_alert() {
        return PushPayload.newBuilder()
                ...
                .setAudience(Audience.alias("15810140695"))
    ...
    //按照别名发送 测试OK
    public static void testSendPushWithCustomConfig2() {
        ClientConfig config = ClientConfig.getInstance();
        // Setup the custom hostname
        config.setPushHostName("https://api.jpush.cn");
    ...
    //按照tag组名发送 
    public static void testSendPushWithCustomConfig3() {
        ClientConfig config = ClientConfig.getInstance();
        // Setup the custom hostname
        config.setPushHostName("https://api.jpush.cn");
